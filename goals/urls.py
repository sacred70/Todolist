...
from goals.views.comments import GoalCommentCreateView, GoalCommentListView, GoalCommenDetailView
...
urlpatterns = [
    ...
    path('goal_comment/<int:pk>', GoalCommenDetailView.as_view(), name='comment-details'),
]
